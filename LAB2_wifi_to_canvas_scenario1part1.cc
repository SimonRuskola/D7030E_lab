...
/////////////////////////////PCAP tracing/////////////////////////////   
  ...
  phy.EnablePcap ("LAB2_SCENARIO1PART1_seed_"+seed_string+"_Bitrate_"+bitrate+"_WIFI_STA", stas, true); 
  phy.EnablePcap ("LAB2_SCENARIO1PART1_seed_"+seed_string+"_Bitrate_"+bitrate+"_WIFI_AP", ap, true); 
  NS_LOG_UNCOND ("LAB2_SCENARIO1PART1_seed_"+seed_string+"_Bitrate_"+bitrate);
