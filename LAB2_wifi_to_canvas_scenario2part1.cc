...
//  phy.Set("CcaMode1Threshold", DoubleValue(-99));
 ...
 /////////////////////////////Deployment///////////////////////////// 
      ...
      positionAlloc->Add (Vector (125.594321576, 0.0, 1.0));

      mobility.SetPositionAllocator (positionAlloc);
      mobility.SetMobilityModel ("ns3::ConstantPositionMobilityModel");
      mobility.Install (stas);
      Ptr<ListPositionAllocator> positionAllocAP = CreateObject<ListPositionAllocator> ();
      positionAllocAP->Add (Vector (62.7971607878, 108.767873055, 1.0));
...
/////////////////////////////PCAP tracing/////////////////////////////   
  ...
  std::string payload_string = std::to_string(payload);
  phy.EnablePcap ("LAB2_SCENARIO2PART1_seed_"+seed_string+"_Bitrate_"+bitrate+"_payload_"+payload_string+"B_WIFI_STA", stas, true); 
  phy.EnablePcap ("LAB2_SCENARIO2PART1_seed_"+seed_string+"_Bitrate_"+bitrate+"_payload_"+payload_string+"B_WIFI_AP", ap, true); 
  NS_LOG_UNCOND ("LAB2_SCENARIO2PART1_seed_"+seed_string+"_Bitrate_"+bitrate+"_payload_"+payload_string);
