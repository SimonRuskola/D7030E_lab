...
//  phy.Set("CcaMode1Threshold", DoubleValue(-99));
 ...
 /////////////////////////////Deployment///////////////////////////// 
      ...
      //positionAlloc2->Add (Vector (0.0, 17.2, 1.0));
      //positionAlloc2->Add (Vector (10.0, 17.2, 1.0));
//
...
/////////////////////////////PCAP tracing///////////////////////////// 
  //int seed = RngSeedManager::GetSeed(); 
  std::string seed_string = std::to_string(seed);
  phy.EnablePcap ("LAB2_SCENARIO1PART2_seed_"+seed_string+"_Bitrate_"+bitrate+"_WIFI_STA", stas, true); 
  phy.EnablePcap ("LAB2_SCENARIO1PART2_seed_"+seed_string+"_Bitrate_"+bitrate+"_WIFI_AP", ap, true); 
  NS_LOG_UNCOND ("LAB2_SCENARIO1PART2_seed_"+seed_string+"_Bitrate_"+bitrate);
